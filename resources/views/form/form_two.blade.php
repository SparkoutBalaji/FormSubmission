<section class="form_2">
    ...
    <div class="row pb-2">
        ...
        <div class="col md-4">
            <div class="form-check">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="check4"
                        id="check4">
        ...
        <div class="col md-6">
            <div class="form-check">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" id="person leaving">
                </div>
                <div class="input-group mb-3">
                    <span class="input-group-text" id="person date">Date that the position became / will
                        be vacant:</span>
                    <input type="text" class="form-control" id="person date">
                </div>
            </div>
        </div>
    ...
    <div class="row pb-2">
        <div class="col-md-10">
            ...
            <input type="text" name="head_signature" class="form-control" id="head_signature">
